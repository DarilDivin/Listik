...
function todo(partial: Partial<Todo> & { id: string }): Todo {
  return {
    ...
    recur_interval: partial.recur_interval ?? 1,
    recur_weekday: partial.recur_weekday ?? null,
    recur_setpos: partial.recur_setpos ?? null,
    recur_mode: partial.recur_mode ?? "fixed",
