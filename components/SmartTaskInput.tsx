...
export default function SmartTaskInput({
  ...
  return (
    <form
      action=""
      className="w-full max-w-4xl rounded-3xl bg-white py-2 px-2 shadow flex items-start gap-4"
    ...
    >
      <div className="relative w-full flex items-center">
        <textarea
          ...
          className="w-full h-8 pl-4 pt-[2px] leading-8 outline-none font-normal text-transparent placeholder:text-gray-400 text-xl border-none resize-none bg-transparent overflow-hidden"
        ...
        />
        <div
          className="text-overlay pl-4 pt-[2px] leading-8 text-gray-800 pointer-events-none w-full absolute top-0 left-0 z-0 font-normal text-xl"
          style={{
            height: "32px",
            whiteSpace: "pre-wrap",
      ...
      >
        <SelectTrigger
          className={`w-[180px] border-none outline-none ring-none ${
